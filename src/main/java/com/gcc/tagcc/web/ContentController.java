...
public class ContentController {
    ...
    @RequestMapping("add_share_content")
    public Object addShareContent(HttpServletRequest req,
                                  @RequestParam(value = "weight", required = false) String weight,
                                  @RequestParam(value = "collection", required = false) String collection,
                                  @RequestParam(value = "icon", required = false) String icon,
                                  @RequestParam(value = "url_name", required = false) String urlName,
                                  @RequestParam(value = "url", required = false) String url){
        url = "http://fanyi.baidu.com/?aldtype=16047#auto/zh";
        icon = "xxx";
        urlName = "百度一下，就知道";
        weight = "1";
        contentService.addShareContent(weight,collection,icon,urlName,url);
        return "success";
    }

    @RequestMapping("query_share_content")
    ...
    @RequestMapping("analysis_share_content")
    public Object analysisShareContent(){
        String html = "<DT><H3 ITEM_ID=\"{A62AF571-6A95-4BA2-8EDD-92A8BB9743F3}\" LAST_MODIFIED=\"1526282232\" >收藏夹栏</H3>\n" +
                "    <DL><p>\n" +
                "    </DL><p>\n" +
